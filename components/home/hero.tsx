  ...
  return (
    <section className="overflow-hidden border-b border-border bg-background" aria-labelledby="hero-title">
      <div className="mx-auto grid max-w-7xl gap-12 px-5 py-16 sm:px-8 sm:py-20 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-20 lg:px-10 lg:py-28">
        <div>
          <p className="text-sm font-semibold uppercase tracking-[0.2em] text-accent">{siteConfig.business.name}</p>
          <h1 id="hero-title" className="mt-5 max-w-3xl text-5xl text-text sm:text-6xl lg:text-7xl">
            Gifts made for every special occasion.
          </h1>
          ...
          <dl className="mt-12 grid max-w-lg grid-cols-2 gap-6 border-t border-border pt-6 sm:grid-cols-3">
            <div>
              <dt className="text-xs uppercase tracking-[0.15em] text-muted">Products</dt>
              <dd className="mt-2 font-heading text-2xl text-pine">Return gifts</dd>
            </div>
            <div>
              <dt className="text-xs uppercase tracking-[0.15em] text-muted">Gifting</dt>
              <dd className="mt-2 font-heading text-2xl text-pine">Corporate</dd>
            </div>
            <div className="col-span-2 sm:col-span-1">
              <dt className="text-xs uppercase tracking-[0.15em] text-muted">Options</dt>
              <dd className="mt-2 font-heading text-2xl text-pine">Customized</dd>
            </div>
          </dl>
        </div>
        ...
        <div className="relative min-h-[22rem] overflow-hidden rounded-[2rem] bg-pine p-7 text-background sm:min-h-[30rem] sm:p-10">
          ...
          <div className="relative flex h-full min-h-[20rem] flex-col justify-between sm:min-h-[26rem]">
            <span className="text-sm font-semibold uppercase tracking-[0.18em] text-background/70">{siteConfig.business.tagline}</span>
            <div>
              <p className="font-heading text-5xl leading-none text-background sm:text-7xl">Useful.</p>
              <p className="font-heading text-5xl leading-none text-accent-light sm:text-7xl">Giftable.</p>
            ...
            <p className="max-w-xs text-sm leading-6 text-background/70">
              Gifts and essentials for the moments that matter.
            </p>
          </div>
        </div>
      </div>
