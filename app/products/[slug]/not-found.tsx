  ...
  return (
    <section className="bg-background" aria-labelledby="product-not-found-title">
      <div className="mx-auto max-w-3xl px-5 py-24 text-center sm:px-8 lg:px-10 lg:py-32">
        ...
        <p className="mx-auto mt-5 max-w-xl text-base leading-7 text-muted">The product link may be out of date. Return to the catalogue to browse the current UrbanNest Traders collection.</p>
